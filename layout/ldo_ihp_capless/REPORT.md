...
| **RC** — once, for this report | same | **`…_k25d_pex_netlist_stitched.spice`** | 186 | 8 583 | **connected**: 220/243 device pins, **0 open nets**, 19 stub nets, 15/15 named ports anchored on a `[Pin]` node | 13/13 ran, **0 spec violations** |
