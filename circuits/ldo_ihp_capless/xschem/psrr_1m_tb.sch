...
S {}
E {}
T {psrr_1m_tb} -40 -200 0 0 0.4 0.4 {}
...
T {psrr_1m_tb -- PSRR} -60 470 0 0 0.5 0.5 {}
T {drawn from decks/candidate/psrr_1m.spice; directives and .control lifted verbatim} -60 510 0 0 0.3 0.3 {}
...
C {devices/code_shown.sym} 316 570 0 0 {name=CONTROL only_toplevel=false value=".control
  set filetype=ascii
  ac dec 20 10 100meg
  meas ac vout_db FIND vdb(vout) AT=1meg
