...
S {}
E {}
T {load_regulation_tb} -40 -200 0 0 0.4 0.4 {}
C {devices/vsource.sym} 240 0 0 0 {name=VDD value="dc \{VDD\}"}
C {devices/vsource.sym} 0 240 0 0 {name=VSS value="dc 0"}
C {devices/isource.sym} 0 0 0 0 {name=ILOAD value="dc 0.1m"}
...
T {load_regulation_tb -- load regulation} -60 470 0 0 0.5 0.5 {}
T {drawn from decks/candidate/load_regulation.spice; directives and .control lifted verbatim} -60 510 0 0 0.3 0.3 {}
