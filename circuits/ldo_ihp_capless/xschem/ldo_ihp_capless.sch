...
C {devices/vsource.sym} -510 260 0 0 {name=VREF value="dc {vref_val}"}
C {devices/vsource.sym} -510 520 0 0 {name=VLP value="dc 0"}
C {devices/capa.sym} 755 260 1 0 {name=XCFF value=cap_cmim}
...
C {devices/capa.sym} 510 390 0 0 {name=XCC value=cap_cmim}
...
C {devices/capa.sym} 2390 520 0 0 {name=XCOUT value=cap_cmim m=c_out_m}
N -510 170 -510 230 {}
N -510 290 -510 350 {}
N -510 430 -510 490 {}
N -510 550 -510 610 {}
...
C {devices/lab_wire.sym} -570 660 0 0 {name=l1 lab=vss}
...
C {devices/lab_wire.sym} 665 260 0 0 {name=l7 lab=fb}
C {devices/lab_wire.sym} 1550 90 2 0 {name=l8 lab=gate}
C {devices/lab_wire.sym} 2130 0 0 0 {name=l9 lab=gate}
C {devices/lab_wire.sym} 785 320 2 0 {name=l10 lab=lp_brk}
C {devices/lab_wire.sym} 1110 260 0 0 {name=l11 lab=nbias}
C {devices/lab_wire.sym} 1450 260 0 0 {name=l12 lab=nbias}
C {devices/lab_wire.sym} 80 0 0 1 {name=l13 lab=pbias}
C {devices/lab_wire.sym} 590 0 0 1 {name=l14 lab=pbias}
C {devices/lab_wire.sym} 1110 0 0 0 {name=l15 lab=pbias}
C {devices/lab_wire.sym} 2230 90 2 0 {name=l16 lab=vout}
C {devices/lab_wire.sym} 90 260 0 0 {name=l17 lab=vref}
C {devices/lab_wire.sym} 1790 260 0 0 {name=l18 lab=x1}
C {devices/lab_wire.sym} 2230 350 2 0 {name=l19 lab=x1}
C {devices/lab_wire.sym} 1450 0 0 0 {name=l20 lab=y}
C {devices/lab_wire.sym} 1790 0 0 0 {name=l21 lab=y}
C {devices/lab_wire.sym} 1890 170 0 1 {name=l22 lab=y}
C {devices/lab_wire.sym} 1270 94 2 0 {name=l23 lab=vdd}
C {devices/lab_wire.sym} -80 94 2 0 {name=l24 lab=vdd}
C {devices/lab_wire.sym} -250 354 2 0 {name=l25 lab=vdd}
C {devices/lab_wire.sym} 250 354 2 0 {name=l26 lab=vdd}
C {devices/lab_wire.sym} 430 94 2 0 {name=l27 lab=vdd}
C {devices/lab_wire.sym} 2290 354 2 0 {name=l28 lab=vdd}
C {devices/lab_wire.sym} 1950 94 2 0 {name=l29 lab=vdd}
C {devices/lab_wire.sym} 1610 94 2 0 {name=l30 lab=vdd}
C {devices/lab_wire.sym} 2290 94 2 0 {name=l31 lab=vdd}
C {devices/lab_wire.sym} 770 614 2 0 {name=l32 lab=vss}
C {devices/lab_wire.sym} 1270 354 2 0 {name=l33 lab=vss}
C {devices/lab_wire.sym} -250 614 2 0 {name=l34 lab=vss}
C {devices/lab_wire.sym} 250 614 2 0 {name=l35 lab=vss}
C {devices/lab_wire.sym} 430 354 2 0 {name=l36 lab=vss}
C {devices/lab_wire.sym} 2290 614 2 0 {name=l37 lab=vss}
C {devices/lab_wire.sym} 1950 354 2 0 {name=l38 lab=vss}
C {devices/lab_wire.sym} 1610 354 2 0 {name=l39 lab=vss}
C {devices/lab_wire.sym} -510 170 0 1 {name=l40 lab=vref}
C {devices/lab_wire.sym} -510 350 2 0 {name=l41 lab=vss}
C {devices/lab_wire.sym} -510 430 0 1 {name=l42 lab=lp_brk}
C {devices/lab_wire.sym} -510 610 2 0 {name=l43 lab=vout}
