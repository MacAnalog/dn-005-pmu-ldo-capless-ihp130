...
S {}
E {}
T {tran_line_step_tb} -40 -200 0 0 0.4 0.4 {}
C {devices/vsource.sym} 480 0 0 0 {name=VDD value="pulse(1.4 1.65 1u 100n 100n 10u 20u)"}
...
T {tran_line_step_tb -- line-step transient} -60 470 0 0 0.5 0.5 {}
T {drawn from decks/candidate/tran_line_step.spice; directives and .control lifted verbatim} -60 510 0 0 0.3 0.3 {}
...
C {devices/code_shown.sym} 316 570 0 0 {name=CONTROL only_toplevel=false value=".control
  set filetype=ascii
  tran 1n 8u
  meas tran vout_max MAX v(vout) from=1u to=8u
