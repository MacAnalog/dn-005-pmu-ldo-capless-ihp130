...
| S2 | load regulation, 0.1 → 10 mA | ≤ 5 mV | **1.27 mV** (0 → 10 mA) | `load_regulation` | match the reference (1.27 mV over 0 → 10 mA) with margin; `perez2018` −0.82 mV/mA and `yuksel2020` 0.0014 mV/mA bracket it |
