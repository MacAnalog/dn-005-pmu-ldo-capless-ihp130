...
`ldo/` helper, or add the doc line the pack could not retrieve. Then record it here with the
ledger tag or experiment that exposed it.

Procedural write (`scripts/`, `ldo/`) — proposed as a diff for owner review per CLAUDE.md rule 10.
