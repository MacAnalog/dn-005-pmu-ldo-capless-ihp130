...
| 2026-09-04 | [singular-matrix-is-a-warning.md](journal/singular-matrix-is-a-warning.md) | procedural | live | ngspice prints `Warning: singular matrix` while gmin-stepping and then converges; lab.sim._FATAL threw away 7 of 13 post-layout benches whose measures were in the log (proposed diff inside) |
