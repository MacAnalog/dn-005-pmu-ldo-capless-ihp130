...
- **Adaptive biasing** (`zhang2023`, `yuksel2020`, `perez2018`): bias current follows the load
...
- **Load-aware feedback divider** (`yuksel2020`): the divider's bias moves with Vout error to
